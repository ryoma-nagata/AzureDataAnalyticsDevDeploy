...
param databricksPublicSubnetIds array = []
param IPWhiteListsCIDR array
...
var databricksNetworkAccessrules = [for databricksPublicSubnetId in databricksPublicSubnetIds: {
...
resource storageExternal 'Microsoft.Storage/storageAccounts@2021-02-01' = {
  ...
  properties: {
    ...
    networkAcls: {
      ...
      ipRules: publicNetworkAccess ? [] : IPWhiteListsCIDR
      virtualNetworkRules: databricksNetworkAccessrules
